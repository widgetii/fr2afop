...
import ru.aplix.converters.fr2afop.fr.image.SVGImage;

@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "PictureView")
public class PictureView extends View {

	@XmlElementRefs({ @XmlElementRef(type = JPEGImage.class), @XmlElementRef(type = BMPImage.class), @XmlElementRef(type = SVGImage.class) })
