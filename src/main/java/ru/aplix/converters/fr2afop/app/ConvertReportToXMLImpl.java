...
public class ConvertReportToXMLImpl extends CommandImpl implements ConvertReportToXML {
	...
	public void execute() throws Exception {
		...
		Configuration configuration = Utils.fileToObject(configurationFile, Configuration.class);
		...
		if (configuration.getReplacementFile() != null) {
			...
			try {
				...
				reportReader = new XMLReportReader();
				report = reportReader.readFromStream(new InputStreamOpener() {
					@Override
					public InputStream openStream() throws IOException {
